...
//   typedef typename pcl::PCLBase <PointT>::PointCloudConstPtr
//   PointCloudConstPtr;
//   typedef typename pcl::PCLBase <PointT>::PointIndicesConstPtr
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setAngleStep(const float step) {
  if (step <= 0.0f) return;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
float OrientedBoundingBox<PointT>::getAngleStep() const {
  return (step_);
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setNormalizePointMassFlag(
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getNormalizePointMassFlag() const {
  return (normalize_);
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setPointMass(const float point_mass) {
  if (point_mass <= 0.0f) return;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
float OrientedBoundingBox<PointT>::getPointMass() const {
  return (point_mass_);
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::compute() {
  if (!initCompute()) {
    deinitCompute();
    return;
  }
  ...
  if (normalize_) {
    if (indices_->size() > 0)
      point_mass_ =
          1.0f / static_cast<float>(indices_->size() * indices_->size());
    else
      point_mass_ = 1.0f;
  }
  ...
  computeEigenVectors(covariance_matrix, major_axis_, middle_axis_, minor_axis_,
                      major_value_, middle_value_, minor_value_);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getAABB(PointT& min_point,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getOBB(
    PointT& min_point, PointT& max_point, PointT& position,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::computeOBB() {
  ...
  for (unsigned int i_point = 0; i_point < number_of_points; i_point++) {
    float x = (input_->points[(*indices_)[i_point]].x - mean_value_(0)) *
                  major_axis_(0) +
              (input_->points[(*indices_)[i_point]].y - mean_value_(1)) *
                  major_axis_(1) +
              (input_->points[(*indices_)[i_point]].z - mean_value_(2)) *
                  major_axis_(2);
    float y = (input_->points[(*indices_)[i_point]].x - mean_value_(0)) *
                  middle_axis_(0) +
              (input_->points[(*indices_)[i_point]].y - mean_value_(1)) *
                  middle_axis_(1) +
              (input_->points[(*indices_)[i_point]].z - mean_value_(2)) *
                  middle_axis_(2);
    float z = (input_->points[(*indices_)[i_point]].x - mean_value_(0)) *
                  minor_axis_(0) +
              (input_->points[(*indices_)[i_point]].y - mean_value_(1)) *
                  minor_axis_(1) +
              (input_->points[(*indices_)[i_point]].z - mean_value_(2)) *
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getEigenValues(float& major, float& middle,
                                                 float& minor) const {
  major = major_value_;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getEigenVectors(
    Eigen::Vector3f& major, Eigen::Vector3f& middle,
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::computeMeanValue() {
  ...
  for (unsigned int i_point = 0; i_point < number_of_points; i_point++) {
    ...
    if (input_->points[(*indices_)[i_point]].x <= aabb_min_point_.x)
      aabb_min_point_.x = input_->points[(*indices_)[i_point]].x;
    if (input_->points[(*indices_)[i_point]].y <= aabb_min_point_.y)
      aabb_min_point_.y = input_->points[(*indices_)[i_point]].y;
    if (input_->points[(*indices_)[i_point]].z <= aabb_min_point_.z)
      aabb_min_point_.z = input_->points[(*indices_)[i_point]].z;

    if (input_->points[(*indices_)[i_point]].x >= aabb_max_point_.x)
      aabb_max_point_.x = input_->points[(*indices_)[i_point]].x;
    if (input_->points[(*indices_)[i_point]].y >= aabb_max_point_.y)
      aabb_max_point_.y = input_->points[(*indices_)[i_point]].y;
    if (input_->points[(*indices_)[i_point]].z >= aabb_max_point_.z)
      aabb_max_point_.z = input_->points[(*indices_)[i_point]].z;
  }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::computeCovarianceMatrix(
    Eigen::Matrix<float, 3, 3>& covariance_matrix) const {
  covariance_matrix.setZero();

  unsigned int number_of_points = static_cast<unsigned int>(indices_->size());
  float factor = 1.0f / static_cast<float>((number_of_points - 1 > 0)
                                               ? (number_of_points - 1)
                                               : 1);
  for (unsigned int i_point = 0; i_point < number_of_points; i_point++) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::rotateVector(
    const Eigen::Vector3f& vector, const Eigen::Vector3f& axis,
  ...
  rotation_matrix << cosine + (1 - cosine) * x * x,
      (1 - cosine) * x * y - sine * z, (1 - cosine) * x * z + sine * y,
      (1 - cosine) * y * x + sine * z, cosine + (1 - cosine) * y * y,
      (1 - cosine) * y * z - sine * x, (1 - cosine) * z * x - sine * y,
      (1 - cosine) * z * y + sine * x, cosine + (1 - cosine) * z * z;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::getProjectedCloud(
  ...
  for (unsigned int i_point = 0; i_point < number_of_points; i_point++) {
    ...
    float K = -(D + normal_vector(0) * input_->points[index].x +
                normal_vector(1) * input_->points[index].y +
                normal_vector(2) * input_->points[index].z);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
bool OrientedBoundingBox<PointT>::getMassCenter(
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setInputCloud(
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setIndices(const IndicesPtr& indices) {
  indices_ = indices;
  fake_indices_ = false;
  use_indices_ = true;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setIndices(const IndicesConstPtr& indices) {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setIndices(
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename PointT>
void OrientedBoundingBox<PointT>::setIndices(size_t row_start, size_t col_start,
